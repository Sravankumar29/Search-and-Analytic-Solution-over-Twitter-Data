    ...
    <script type="text/javascript">
        ...
        function drawChart1() {
            ...
            var data = new google.visualization.arrayToDataTable([
                ...
                ['Social Unrest', ${all_topics['Social Unrest']}],
                ['Politics', ${all_topics['Politics']}],
                ['Infrastructure', ${all_topics['Infra']}],
                ['Crime', ${all_topics['Crime']}],
                ['Environment', ${all_topics['Environment']}],
            ]);
        ...
        function drawChart2() {
            ...
            var twcount=${cities['Delhi']}+${cities['Paris']}+${cities['Bangkok']}+${cities['NYC']}+${cities['Mexico City']}
            var data = new google.visualization.arrayToDataTable([
